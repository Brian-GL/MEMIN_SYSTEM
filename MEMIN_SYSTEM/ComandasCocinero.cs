...
{
	/// <summary>
	/// Description of ComandasCocinero.
	/// </summary>
	public partial class ComandasCocinero : Form
	{
		MySqlConnection myConnection;
		public ComandasCocinero(FormWindowState ws, Color c)
		{
			//
		...
		void ComandasCocineroFormClosing(object sender, FormClosingEventArgs e)
		{
		...
		void ButtonBuscarClick(object sender, EventArgs e)
		{
			...
			string sentence = "SELECT ID_COMANDA,ESTATUS FROM COMANDA WHERE ID_EMPLEADO_COCINA = "+numericUpDownIDCocinero.Value+" and fecha_creacion between '"+fechaInicio+"' and '"+fechaFin+"' ;";
			myConnection.Open();
