...
{
	/// <summary>
	/// Description of ComandasMesero.
	/// </summary>
	/// 
	
	public partial class ComandasMesero : Form
	{
		
		MySqlConnection myConnection;
		public ComandasMesero(FormWindowState ws,Color c)
		{
			//
		...
		void ComandasMeseroFormClosing(object sender, FormClosingEventArgs e)
		{
		...
		void ButtonBuscarClick(object sender, EventArgs e)
		{
			...
			string sentence = "SELECT ID_COMANDA,ESTATUS FROM COMANDA WHERE ID_EMPLEADO_MESERO = "+numericUpDownIDMesero.Value+" and fecha_creacion between '"+fechaInicio+"' and '"+fechaFin+"' ;";
			myConnection.Open();
